...
class FluxAttnProcessor2_0:
    ...
    def __call__(
        ...
        train_seq_len = 64 ** 2  + 64 ** 2 + 512 # TODO: Check if this is correct for Kontext
        ...
        hidden_states = F.scaled_dot_product_attention(
            query, key, value, attn_mask=attention_mask, dropout_p=0.0, is_causal=False, scale=attention_scale
        )
